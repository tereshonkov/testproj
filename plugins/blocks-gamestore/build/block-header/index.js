...
function Edit({
  ...
  const {
    memberLink,
    cartLink
  } = attributes; // Деструктуризация атрибутов блока для удобного доступа
...
function save({
  ...
  const {
    memberLink,
    cartLink
  } = attributes; // Деструктуризация атрибутов блока
