					...
					<div className="header-mode-switcher">
						<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
							<g stroke="var(--action-main)" stroke-opacity="0.64" stroke-linecap="round" stroke-linejoin="round">
								...
								<path d="M21 24C24.3137 24 27 21.3137 27 18C27 14.6863 24.3137 12 21 12C17.6863 12 15 14.6863 15 18C15 21.3137 17.6863 24 21 24Z"/>
							</g>
						</svg>
					</div>
					{cartLink && (
